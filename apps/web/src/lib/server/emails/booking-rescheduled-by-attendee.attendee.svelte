<script lang="ts">
	import { Layout, Heading, Actions, Button, DetailTable } from '$lib/server/email/components';
...
<Layout name={orgName} {primaryColor} footerHref={links.booked}>
	<Heading>Your booking has been moved to a new time.</Heading>
	<DetailTable
		rows={[
	...
	/>
	<Actions>
		<Button href={links.reschedule} kind="secondary">Reschedule again</Button>
