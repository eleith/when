import Attendee from './booking-rescheduled-by-attendee.attendee.svelte';
import Admin from './booking-rescheduled-by-attendee.admin.svelte';
...
export function bookingRescheduledByAttendee(i: BookingEmailInput): Envelope[] {
